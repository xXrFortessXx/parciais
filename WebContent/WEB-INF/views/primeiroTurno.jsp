...
<html>
	<head>
		...
		<title>Liga de Primeiro Turno- Parciais Cartola</title>
	...
	<body>
	  ...
	  <div class="p-5">
	    <div class="container">
	      <div class="row">
	        <div class="col-md-12">
	          <h1 class="mb-4 text-primary text-center">O Ultimo é Viado (UEV)</h1>
	        </div>
	      </div>
	    </div>
	    <form id="idFormDetailLiga" name="formDetailLiga" action=<%=ParciaisCartolaKeys.DETALHE_LIGAS%>>
		    <div class="container">
			    <c:forEach var="time" items="${usuarioBean.ligaSelecionada.times}" varStatus="index">
			                ...
			                <tbody class="m-2">
			                  <tr class="my-2">
			                    <td class="bg-faded" style="border-left: 2px solid gray; width: 200px;">
	                				<img src="${time.escudo}" style="width: 150px;">
                				</td>
		                		...
		                		text-align: left; font-family: Roboto-Regular; font-size: xx-large;">
	                				<strong>${time.nome}<br/></strong>${time.nomeCartola}
	                			</td>
		                		...
		                		text-align: left; font-family: Roboto-Regular; font-size: xx-large; color: black;">
		                			<strong>Pontos: </strong>${time.pontos.campeonato}<br/><strong>Pos. </strong>${time.posicaoTurno}
	                			</td>
			                  </tr>
