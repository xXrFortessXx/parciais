...
<html>
	<head>
		...
		<title>Parciais do Time - Parciais Cartola</title>
	...
	<body>
	  ...
	  <div class="p-5">
	    <div class="container">
	      <div class="row">
	        <div class="col-md-12">
	          <h1 class="mb-4 text-primary text-center">Parciais do Time</h1>
	        </div>
	      </div>
	    </div>
	    <form id="idFormDetailLiga" name="formDetailLiga" action=<%=ParciaisCartolaKeys.DETALHE_LIGAS%>>
		    <div class="container">
			    <c:forEach var="jogador" items="${usuarioBean.timeUsuario}" varStatus="index">
